...
- Change version Number in app.config.js prior to generating builds
- Refer https://docs.expo.dev/distribution/uploading-apps/ for generating apk for playstore deployment
